...
const categoryService = require("../../services/product/product.category.service");
...
router.post("/create", async (req, res) => {
    try {
        ...
        let statusCode = err.message.includes("Thiếu tên danh mục") || err.message.includes("Thiếu slug danh mục") ? 400 : 500;
